...
public class CalendarioView extends javax.swing.JDialog {
    ...
    public CalendarioView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public CalendarioView(ConfiguracaoModel co){
        initComponents();
        this.config = co;
        setLocationRelativeTo(null);
        setVisible(true);
    ...
    private void initComponents() {
        ...
        calendario.setPreferredCols(4);
        calendario.setPreferredRows(3);
